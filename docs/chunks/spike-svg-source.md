...
## Acceptance criteria
- [ ] ADR committed.
- [ ] Source files committed under `apps/mobile/assets/body/`.
- [ ] Each region path has a stable `id` attribute matching planned `BodyRegion.id` slug.
- [ ] Proof-of-concept tap test on iOS sim + Android emulator confirms tappability.
- [ ] License obligations (attribution text, share-alike) noted in ADR.
